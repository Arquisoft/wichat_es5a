...
* **Deployment:** Es el proceso de poner en funcionamiento la aplicación para que se pueda ejecutar y acceder a ella. Para realizar el deployment utilizamos docker para construir las imagenes de los servicios y subirlas al repositorio.
